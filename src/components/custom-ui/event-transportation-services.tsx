...
const paras1 = [
  ...
  },
  {
    ...
    content:
      "Ensure guests arrive relaxed and ready to celebrate, even if they’re flying in from around the globe. Our convenient airport transfers deliver them to your event venue quickly and efficiently.",
  },
  {
